            ...
            success: (response) => {
                ...
                const createSurfboardListItem = (surfboard) => {
                    const listItem = $(
                        ...
                        `<button class="btn btn-primary" type="button" style="background:url('../img/${surfboard.image[0]}') center / cover no-repeat; height: 200px; width: 150px; border-color: rgba(0, 0, 0, 0);"></button>` +
