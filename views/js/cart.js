                ...
                cart.products.forEach((product) => {
                    const listItem = $(
                        ...
                        '<div style="text-align: center; font-family: Montserrat, sans-serif;">' +
                            ...
                            `<button class="btn btn-primary" type="button" disabled style="background:url('../img/surfboards/${product.productId.image}') center / cover no-repeat; height: 200px; width: 150px; border-color: rgba(0, 0, 0, 0);"></button>` +
